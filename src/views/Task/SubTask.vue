    ...
    <div class="w1200" overflow>
        <div class="cr_bg fl subnl d_subnl">
            <div class="subanw_t">
                <div class="subanw_tn">
                    ...
                    <div class="subanw_tn_se">
                        <select class="pop_ulipt" v-model="task_type">
                            <option value="1">单人提交</option>
                            <option value="2">班级提交 - 按人</option>
                            <option value="3">班级提交 - 按题</option>
                        </select>
                        <i class="pu_i"></i>
                    </div>
                </div>
                ...
                <div class="subanw_tn" v-show="task_type == 1">
            ...
            <div class="saw_list" v-for="(item, index) in answers">
                ...
                <div v-for="(user, uindex) in grade_users">
                    <div class="saw_list_df">
                        ...
                        <div class="ib_lc" v-if="item.subjective == 1">
                            <span :class="{'on': user.answers[index].myanswer.indexOf(option) >= 0}" v-for="option in item.options" @click="saveAnswers(uindex, item.orders, option, item.ismultichoice)">{{option}}</span> 
                        </div>
                        <div class="ib_lc ib_lcn" v-else-if="item.subjective == 2">
                        ...
                        <div class="saw_list_bb">
                            ...
                            <div class="saw_list_bb_df">
                                <label :for="index + '-w' + index1 + uindex" :name="user.uid+item.orders|why" class="d_cb" v-for="(reason, index1) in reasons"> 
                                    {{reason}}
                                    <input :id="index + '-w' + index1 + uindex" type="checkbox" :value="index1" v-model="user.answers[index].reason_ids">
                                    <span></span>
                                </label>
                            </div>
                        </div> 
                        <textarea class="saw_list_bt" maxlength="50" v-model="user.answers[index].parse" v-show="user.answers[index].reason_ids.indexOf(last_reason) != -1"></textarea>
                    </div>
